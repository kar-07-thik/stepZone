...
const Nav = () => {
    ...
    const { cardHandler, authCheck, Addtocardicon } = useContext(Context)
    ...
    return (
        <>
            ...
            {/* Mobile view */}
            <div className="bg-black h-[300px] flex flex-col  ">
                <div className=" flex flex-col w-full z-20 sticky top-0 p-5">
                    <div style={{ boxShadow: "rgba(0, 0, 0, 0.24) 0px 3px 8px" }} className="bg-white px-3 flex justify-between items-center  rounded-t-2xl p-1 md:hidden ">
                    ...
                    <div className="flex gap-10 bg-gray-300 text-balck p-1 px-4 rounded-b-2xl md:hidden">
                        <Link to={"/Collection/Men"}><p className="cursor-pointer">Men</p></Link>
                        <Link to={"/Collection/Women"}><p className="cursor-pointer">Women</p></Link>
                        <Link to={"/Collection/Sales"}><p className="cursor-pointer">Sales</p></Link>
                    </div>
                ...
                <div className="text-center w-[90%] m-auto">
                    <h1 className="text-2xl font-medium text-white">Get 30% Off When Yoy Spend $150 or More</h1>
                    <p className="text-white">Discount Automatically Applied at Checkout.</p>
                </div>
            </div >
        </>
    )
